...
internals.ContentNodeManager.prototype.add = function(contentNode, options)
{
    ...
    var promise = promiseutils.createPromise(function(resolve, reject) {
        ...
        if (!contentNode.refName) {
            contentNode.refName = contentNode.uuid || contentNode.metadata.title;
        }
 ...
 *      options.fetchAncestors - Whether or not to fetch items
 *
        ...
        .then(function(contentNodeModel) {
            ...
            if (contentNodeModel) {
                ...
                .then(function(result){
                    ...
                    {
                        this.retrieveAncestors_(result, options, 0)
                        .then(function(result){
                            resolve(result);
                        })
                        .catch(function(error) {
 ...
 * @return {models.ContentNode}  - The found node with it's descendants
 */
internals.ContentNodeManager.prototype.retrieveAncestors_ = function(contentNode, options, level)
{
    var promise = promiseutils.createPromise(function(resolve, reject) {
        ...
        if (contentNode.parentUuid) {
            ...
            .then(function(parentContentNodeModel) {
                ...
                if (parentContentNodeModel) {
                    ...
                    this.retrieveAncestors_(parentContentNode, options, level + 1)
                    .then(function(result){
                        resolve(contentNode);
                    })
                    .catch(function(error) {
