 ...
 */
internals.ContentNodeManager.prototype.query = function(criteria, contextIds, sort, offset, limit)
{
    return this.contentNodeProvider.query(criteria, contextIds, sort, offset, limit)
}
