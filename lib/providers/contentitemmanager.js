 ...
 */
internals.ContentItemManager.prototype.query = function(criteria, contextIds, sort, offset, limit)
{
    return this.contentItemProvider.query(criteria, contextIds, sort, offset, limit)
}
