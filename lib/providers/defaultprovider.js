...
internals.DefaultProvider.prototype.add = function(resource)
{
...
internals.DefaultProvider.prototype.find = function(criteria)
{
 ...
 */
internals.DefaultProvider.prototype.query = function(criteria)
{
...
internals.DefaultProvider.prototype.update = function(resource)
{
	var promise = promiseutils.createPromise(function(resolve, reject) {

		this.find(resource[this.primaryKey_])
		...
		.catch(function(resourceModel){
			// Error retrieving model from data source.
		});
...
internals.DefaultProvider.prototype.delete = function(pk)
{
	var criteria = {};
	criteria[this.primaryKey_] = pk;
 ...
 * Factory method
 */
internals.createProvider = function(modelName, schema)
{
	var schemaObj = null;
	...
	return new internals.DefaultProvider(modelName, schemaObj);
}
