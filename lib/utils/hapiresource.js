...
internals.HapiResource.prototype.registerRoutesRecursive_ = function(server, ptr)
{
    ...
    server.route({
        ...
        handler: function(request, reply) {
            ...
            var sort = {};
            var limit = request.query._limit || 50;
            var offset = 0;
            ...
            try {
                ...
                ptr.provider_.query(criteria, undefined, sort, offset, limit)
    ...
    server.route({
        ...
        handler: function(request, reply) {
            ...
            try {
                // @todo - Validate the contentItem
                var promise = ptr.provider_.update(contextIds, resource, contextIds);
                promise.then(function(resource){
                    response = resource;
