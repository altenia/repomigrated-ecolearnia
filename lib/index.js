...
exports.register = function(plugin, options, next) {
    ...
    var contentNodeResource = new HapiResource(settings.pathBase, 'node', contentNodeProvider, criteriaKeyDictionary1);

    var criteriaKeyDictionary2 = {
        id: 'uuid',
        nodeId: 'parentUuid'
    }
    var contentItemResource = new HapiResource(null, 'item', contentItemManager, criteriaKeyDictionary2);
