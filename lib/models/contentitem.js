...
internals.getSchemaDefObject = function()
{
    return {
        ...
        body: {
            ...
            components: [internals.ComponentsSchema],

            // Specification for action (e.g. solution, hints)
            actions: Schema.Types.Mixed,

            // Specification for process flow filters (e.g. before rendering)
            processFlow: Schema.Types.Mixed,
